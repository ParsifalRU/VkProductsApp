...
5. бренд
6. категория
7. отображаются картинки товара
8. рейтинг представлен звездами (RatingBar)
...
Письмо о отркытии тестирования слегка проспал и поэтому не успел реализовать 2 последних дополнительных пункта )
